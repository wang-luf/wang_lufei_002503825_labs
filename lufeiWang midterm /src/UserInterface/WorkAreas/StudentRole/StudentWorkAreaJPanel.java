...
public class StudentWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public StudentWorkAreaJPanel(Business b, StudentProfile spp, JPanel clp) {
        ...
        public StudentWorkAreaJPanel(JPanel mainContainer, Business business, AccessControl.Session session) {
            StudentProfile sp = null;
            try {
                if (session != null && session.getProfile() instanceof StudentProfile) {
                    sp = (StudentProfile) session.getProfile();
                }
            } catch (Exception ignore) {}

            if (sp == null) {
                JOptionPane.showMessageDialog(mainContainer,
                        "Current session does not have a Student profile. Please login as Student.",
                        "Profile Warning",
                        JOptionPane.WARNING_MESSAGE);
            }

            this.business = business;
            this.CardSequencePanel = mainContainer;
            this.student = sp;
