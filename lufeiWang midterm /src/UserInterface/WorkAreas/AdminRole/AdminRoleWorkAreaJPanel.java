...
public class AdminRoleWorkAreaJPanel extends javax.swing.JPanel {
    ...
    Business business;
    private AccessControl.Session session;
    ...
    public AdminRoleWorkAreaJPanel(JPanel mainContainer, Business business, AccessControl.Session session) {
        this(business, mainContainer); 
        try {
            java.lang.reflect.Field f = this.getClass().getDeclaredField("session");
            f.setAccessible(true);
            f.set(this, session);
        } catch (Exception ignore) {}
    }
    
    public void setSession(AccessControl.Session session) {
    ...
    private void initComponents() {
        ...
        jButton11.setText("Admin Analytics");
        jButton11.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButton11.setMaximumSize(new java.awt.Dimension(145, 40));
        ...
        jButton11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton11IdentifyEventsActionPerformed(evt);
            }
        });
    ...
    private void btnLogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogoutActionPerformed
        ...
        cl.show(CardSequencePanel, "loginCard");   
    ...
    private void jButton7IdentifyEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7IdentifyEventsActionPerformed
        AssignFacultyToCourseJPanel p = new AssignFacultyToCourseJPanel(business, CardSequencePanel);
        CardSequencePanel.add("AssignFacultyToCourseJPanel", p);
        ((CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    }//GEN-LAST:event_jButton7IdentifyEventsActionPerformed

    private void jButton11IdentifyEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11IdentifyEventsActionPerformed
        AdminAnalyticsJPanel p = new AdminAnalyticsJPanel(business, CardSequencePanel);
        CardSequencePanel.add("AdminAnalytics", p);
        ((CardLayout)CardSequencePanel.getLayout()).next(CardSequencePanel);
    }//GEN-LAST:event_jButton11IdentifyEventsActionPerformed
